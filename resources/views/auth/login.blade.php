...
@section('content')
<div class="prms-auth-split">
    <div class="prms-auth-form-side">
        <div class="prms-auth-card-body px-4 px-md-4 py-4">
    ...
    <aside class="prms-auth-welcome-side" aria-label="{{ __('Welcome') }}">
        <div class="prms-auth-welcome-inner">
            <div class="prms-auth-welcome-icon" aria-hidden="true">
                <i class="far fa-user-circle"></i>
            </div>
            <h1 class="prms-auth-heading h2 mb-2">Welcome back</h1>
            <p class="prms-auth-lead mb-0">
